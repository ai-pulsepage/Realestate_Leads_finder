 ...
 * Based on MDPA readme documentation
 */
const MUNROLL_COLUMNS = {
    ...
    TOTAL_VALUE: 7,
    ASSESSED_VALUE: 8,
    WVDB_EXEMPT: 9,        // Widow, Veterans, Disabled, Blind
    HEX_EXEMPT: 10,        // Homestead
    SECOND_HEX: 11,
    SENIOR_EXEMPT: 12,
    GPAR_EXEMPT: 13,
    OTHER_EXEMPT: 14,
    ...
    UNITS: 37,
    YEAR_BUILT: 38,
    EFFECTIVE_YEAR_BUILT: 39,
    SALE_TYPE_1: 40,
    SALE_QUAL_1: 41,
    SALE_DATE_1: 42,       // Most recent sale
    SALE_AMT_1: 43,
    SALE_TYPE_2: 44,
    SALE_QUAL_2: 45,
    SALE_DATE_2: 46,
...
function parseRecord(fields) {
    ...
    return {
        ...
        sqft: parseInt(fields[MUNROLL_COLUMNS.SQFT]) || null,
